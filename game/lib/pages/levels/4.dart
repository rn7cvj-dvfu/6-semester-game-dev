  ...
  late final List<_SubStage> _stages = [
    _SubStage(
      ...
      graphModel: GraphModel(
        ...
        edges: [
          MicrosoftEdgeModel(id: 'A-B', firstNodeId: 'A', secondNodeId: 'B'),
          MicrosoftEdgeModel(id: 'B-C', firstNodeId: 'B', secondNodeId: 'C'),

          MicrosoftEdgeModel(id: 'C-D', firstNodeId: 'C', secondNodeId: 'D'),
        ],
        clickable: false,
        movable: false,
      ),
    ...
    _SubStage(
      ...
      graphModel: GraphModel(
        ...
        edges: [
          ...
          MicrosoftEdgeModel(id: 'B-C', firstNodeId: 'B', secondNodeId: 'C'),
          MicrosoftEdgeModel(id: 'C-D', firstNodeId: 'C', secondNodeId: 'D'),
          MicrosoftEdgeModel(id: 'D-E', firstNodeId: 'D', secondNodeId: 'E'),
          MicrosoftEdgeModel(id: 'E-F', firstNodeId: 'E', secondNodeId: 'F'),
        ],
        clickable: false,
        movable: false,
      ),
